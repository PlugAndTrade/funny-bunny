...
const decode = R.cond([
  [ R.pathSatisfies(R.equals('gzip'), [ 'properties', 'contentEncoding' ]), R.over(R.lensProp('content'), R.pipe(gunzip, R.toString)) ],
...
const encode = R.cond([
  [ R.pathSatisfies(R.equals('gzip'), [ 'properties', 'contentEncoding' ]), R.over(R.lensProp('content'), R.pipe(R.curryN(1, Buffer.from), gzip)) ],
